 ...
 */
public class TRTCRawEnterActivity extends AppCompatActivity {
    ...
    private void startEnterRoom() {
        if (TextUtils.isEmpty(mEditInputUserId.getText().toString().trim()) || TextUtils
            ...
            Toast.makeText(TRTCRawEnterActivity.this, getString(R.string.audiocall_input_error_tip),
                    Toast.LENGTH_LONG).show();
            return;
        }
        Intent intent = new Intent(TRTCRawEnterActivity.this, TRTCRawActivity.class);
